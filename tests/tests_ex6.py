...
class TestEx6(unittest.TestCase):
    ...
    def test_fun_total_goals_by_team(self):
        ...
        self.assertTrue(all(total_goals_values[i] >= total_goals_values[i+1] 
    ...
    def test_fun_summary_1996_2025_with_dataframe(self):
        ...
        self.assertTrue(all(points_values[i] >= points_values[i+1] 
...
class TestEx6Integration(unittest.TestCase):
    ...
    def test_workflow_consistency(self):
        ...
        # Calcular gols
        home_goals, away_goals, total_goals = ex6.fun_total_goals(self.larger_data)
